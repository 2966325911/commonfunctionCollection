...
public interface RetrofitHttpService {
    ...
    @POST()
    Call<String> post(@Url String url, @Body String jason, @HeaderMap Map<String, String> headers);
    ...
    @FormUrlEncoded
    @POST()
    Observable<String> Obpost(@Url String url, @FieldMap Map<String, Object> params, @HeaderMap Map<String, String> headers);
    ...
    @FormUrlEncoded
    @PUT
    Observable<String> Obput(@Url String url, @FieldMap Map<String, Object> params, @HeaderMap Map<String, String> headers);

    @Streaming
    @GET()
    Observable<ResponseBody> Obdownload(@HeaderMap Map<String, String> headers, @Url String url, @QueryMap Map<String, Object> params);
