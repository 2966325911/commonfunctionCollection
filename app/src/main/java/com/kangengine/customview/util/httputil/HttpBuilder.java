...
import com.kangengine.customview.util.httputil.utils.NetUtils;
import com.kangengine.customview.util.httputil.utils.WriteFileUtil;
...
import static com.kangengine.customview.util.httputil.HttpUtil.checkHeaders;
import static com.kangengine.customview.util.httputil.HttpUtil.checkParams;
import static com.kangengine.customview.util.httputil.HttpUtil.putCall;
...
//                        }
//                );
        observable.observeOn(Schedulers.io()).subscribe(new Consumer<ResponseBody>() {
            @Override
            public void accept(ResponseBody responseBody) throws Exception {
                WriteFileUtil.writeFile(responseBody,path,mProgressListener,mSuccessCallBack,mErrorCallBack);
            }
        });
//                .subscribe(body -> WriteFileUtil.writeFile(body, path, mProgressListener, mSuccessCallBack, mErrorCallBack), t -> {
//                            mErrorCallBack.Error(t);
