package com.kangengine.customview.util.httputil.interceptor;

import android.content.Context;


import com.kangengine.customview.AppContextAppliction;
import com.kangengine.customview.util.SystemUtil;
import com.kangengine.customview.util.httputil.HttpUtil;
...
public class CacheInterceptor implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        Context context= AppContextAppliction.getInstance();
