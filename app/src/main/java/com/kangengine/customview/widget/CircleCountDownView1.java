 ...
 * desc   :
 */
public class CircleCountDownView1 extends View{
    ...
    public CircleCountDownView1(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int radius = (int) (mCircleRadius - 6 * mProgressWidth);
        if(isBgCircle) {
            ...
            int bottom = centerX + radius;

            canvas.drawRoundRect(left,top,right,bottom,10,10,mPaint);
        }
